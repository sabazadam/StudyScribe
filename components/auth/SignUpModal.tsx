 ...
 * ==============================================================================
 * Modal for new user registration with email/password
 * Includes validation, password strength indicator, and error handling
 * ==============================================================================
 */
...
export default function SignUpModal({
  ...
  return (
    ...
    >
      <div
        className="relative bg-white dark:bg-card-dark rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto animate-slide-up"
      ...
      >
        ...
        <div className="mb-6">
          <h2
            ...
            className="text-2xl font-heading font-bold text-oxford-blue dark:text-text-dark mb-2"
          >
            Create Account
          </h2>
          <p className="text-text-muted dark:text-text-dark-muted">
            Start transforming your lectures into study materials
          </p>
        </div>

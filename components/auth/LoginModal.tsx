 ...
 * ==============================================================================
 * Modal for user authentication with email/password and Google sign-in
 * Includes error handling, loading states, and navigation to sign up
 * ==============================================================================
 */
...
export default function LoginModal({
  ...
  return (
    ...
    >
      <div
        className="relative bg-white dark:bg-card-dark rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 animate-slide-up"
      ...
      >
        ...
        <div className="mb-6">
          ...
          <p className="text-text-muted dark:text-text-dark-muted">
            Sign in to continue to CrammingAI
          </p>
        </div>

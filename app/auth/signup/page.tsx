 ...
 * SIGN UP PAGE
 * ==============================================================================
 * Standalone sign-up page with email/password and Google authentication
...
function SignUpContent() {
  ...
  return (
    <div className="min-h-screen bg-mesh-academic dark:bg-mesh-academic-dark texture-noise flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        {/* Sign Up Card */}
        <div className="bg-white dark:bg-card-dark rounded-2xl shadow-xl p-8 max-h-[85vh] overflow-y-auto">
